...
<body class="premium standard u-fix-fancybox-iframe">
            ...
            <nav class="discovery--nav">
                <ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
                    ...
                    <li class="discovery--nav--list--item tab-filter--item">
                        <a class="tab-filter"
                            href='songsIndex.aspx?artistId=<%= Request.QueryString["artistId"] %> '>Songs</a>
                    </li>
                    <li class="discovery--nav--list--item tab-filter--item">
                        <a class="tab-filter"
                            href='albumsIndex.aspx?artistId=<%= Request.QueryString["artistId"] %> '>Albums</a>
                    </li>
                </ul>
                    ...
                    <section class="standard--holder">
                        <div class="discovery--section--header">
                            ...
                            <a class="discovery--section--header--view-all"
                                href='songsIndex.aspx?artistId=<%= Request.QueryString["artistId"] %> '>View All</a>
                        </div>
                        <!-- /.discovery-select -->
                                ...
                                <ItemTemplate>
                                    <li class="song-list--item media-player--row">
                                        ...
                                        <div class="song-list--item--right">
                                            ...
                                            <a class="song-list--item--secondary"><%# Eval("Rate") %></a>
    ...
    <a class="media-item--img--link" href='albumDetails.aspx?artistId=<%# Request.QueryString["artistId"] %>&albumId=<%# Eval("AlbumId") %>' tabindex="0">
    ...
    <a class="media-item--title" href='albumDetails.aspx?artistId=<%# Request.QueryString["artistId"] %>&albumId=<%# Eval("AlbumId") %>' tabindex="0"><%# Eval("AlbumName") %></a>
    <a class="media-item--subtitle" href='albumDetails.aspx?artistId=<%# Request.QueryString["artistId"] %>&albumId=<%# Eval("AlbumId") %>' tabindex="0"><%# Eval("Year") %></a>
</div>
